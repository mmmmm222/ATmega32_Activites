using ADC to read the analog value then convert it to digital then put it in the OCR1A register after mapping it to generate a signal that control the servo motor 
